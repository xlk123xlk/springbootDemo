...
public class RedisUtils {
	 ...
	 * @return
	 */
	public static boolean hset(String key,String item,Object obj) {
		try {
	 ...
	 * @return
	 */
	public static boolean hset(String key,String item,Object obj,long time) {
		try {
			hset(key,item,obj);
			if(time > 0) {
				expire(key,time);
	...
	//判断hash表中是否有该项的值
	public static boolean hHasKey(String key,Object obj) {
	...
	// 移除值为value的
	public static long setRemove(String key,Object...obj) {
		try {
	 ...
	 * @return
	 */
	public static List<Object> lGet(String key,long begin,long end){
		try {
